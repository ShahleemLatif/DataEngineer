import configparser
import psycopg2
from sql_queries import create_schemas_queries, create_table_queries, drop_schemas_queries, drop_table_queries
...
def drop_tables(cur, conn):
    '''
    Function to drop table. This function uses the variable 'drop_table_queries' defined in the 'sql_queries.py' file.
    Parameters:
        - curr: Cursor for a database connection
        - conn: Database connection
    Outputs:
...
def create_tables(cur, conn):
    '''
    Function to create table. This function uses the variable 'create_table_queries' defined in the 'sql_queries.py' file.
    Parameters:
        - curr: Cursor for a database connection
        - conn: Database connection
    Outputs:
